        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i>Your cellar contents
                            <div class="pull-right">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown">
                                        Actions
																...
																$query = $db->query("SELECT count(*)
																					FROM 
																						(SELECT USERS_BEER_NAME
																								...
																								, USERS_BEER_VINTAGE
																						FROM users_beer
																						WHERE USERS_BEER_NAME = '".addslashes($beerName)."'
																								 AND USERS_BREWERY_NAME = '".addslashes($breweryName)."'
